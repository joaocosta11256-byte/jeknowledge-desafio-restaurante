...
5.  **Atualizações em tempo Real:** Implementei *Short Polling* (a cada 5 segundos) no React.
6.  **Dashboard Kanban Interativo:** O quadro da cozinha permite arrastar os cartões entre as fases utilizando a **API nativa do HTML5**. Adicionalmente, mantive os botões nos cartões em simultâneo com o *Drag-and-Drop* para garantir 100% de **acessibilidade** e compatibilidade com ecrãs táteis.
